  ...
  return (
    <article className="mt-4 p-4">
      ...
      <h3 className="text-center text-8xl font-bold">
        <TemperatureUnit temperature={data.main.temp} removeDecoration />
      </h3>

      <p className="text-center mt-2">
        Sensação de <TemperatureUnit temperature={data.main.feels_like} />.
      </p>
      ...
      <ComplementaryWeather
        ...
        list={[
          {
            title: 'Vento',
            description: <SpeedUnit speed={data.wind.speed * 3.6} />,
          },
          {
            title: 'Umidade',
